...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cmake-no-system-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cmake-no-system-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cmake-no-system
# for installing globally
pixi global install cmake-no-system
```
...
It is possible to list all of the versions of `cmake-no-system` available on your platform:
...
```
pixi search cmake-no-system --channel conda-forge
```
